...
class Testlogin(unittest.TestCase): 
    ...
    def test_login(self): 
        ...
        #validasi
        response_message = driver.find_element(By.XPATH,"/html/body/div/div[1]/div[2]/div[2]/div/div[2]/div[3]/div/div[2]/div/div/div[2]/div").text
        self.assertEqual(response_message, 'Kevin Mathews')
