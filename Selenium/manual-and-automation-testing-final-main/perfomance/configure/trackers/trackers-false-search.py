...
class Testlogin(unittest.TestCase): 
    ...
    def test_login(self): 
        ...
        time.sleep(3)
        driver.find_element(By.XPATH, "/html/body/div/div[1]/div[2]/div[2]/div/div[1]/div[2]/form/div[1]/div/div/div/div[2]/div/div/input").send_keys("Kevin Mathew") #isi Kevin Mathews 
        time.sleep(3)
        ...
        #validasi
        response_message = driver.find_element(By.XPATH,"/html/body/div/div[1]/div[2]/div[2]/div/div[1]/div[2]/form/div[1]/div/div/div/span").text
