...
class Testlogin(unittest.TestCase): 
    ...
    def test_login(self): 
        ...
        time.sleep(3)
        driver.find_element(By.XPATH, "/html/body/div/div[1]/div[2]/div[2]/div/div[2]/div[3]/div/div[2]/div[1]/div/div[6]/div/button[2]").click() #klik icon pensil/edit
        time.sleep(3)
        driver.find_element(By.XPATH, "/html/body/div/div[1]/div[2]/div[2]/div/div/form/div[1]/div/div/div/div[2]/input").send_keys("Tracker for arsha") #isi arsha
        time.sleep(3)
