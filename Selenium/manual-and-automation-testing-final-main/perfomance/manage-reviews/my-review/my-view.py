...
class Testlogin(unittest.TestCase): 
    ...
    def test_login(self): 
        ...
        time.sleep(3)
        driver.find_element(By.XPATH, "/html/body/div/div[1]/div[1]/header/div[2]/nav/ul/li[2]/ul/li[2]/a").click() #klik my review pada menu dropdown
        time.sleep(4)
        driver.find_element(By.XPATH, "/html/body/div/div[1]/div[2]/div[2]/div/div/div[3]/div/div[2]/div/div/div[7]/div/button").click() #klik button evaluate
        time.sleep(4)
        
        
        #validasi
        response_message = driver.find_element(By.XPATH,"/html/body/div/div[1]/div[2]/div[2]/div/div[1]/h5").text
        self.assertEqual(response_message, 'Performance Review')
