...
class Testlogin(unittest.TestCase): 
    ...
    def test_login(self): 
        ...
        time.sleep(3)
        driver.find_element(By.XPATH, "/html/body/div/div[1]/div[1]/header/div[2]/nav/ul/li[2]/ul/li[3]/a").click() #klik employee review pada menu dropdown
        time.sleep(4)
        
        
        #validasi
        response_message = driver.find_element(By.XPATH,"/html/body/div/div[1]/div[2]/div[2]/div/div[1]/div[1]/div[1]/h5").text
        self.assertEqual(response_message, 'Employee Reviews')
